module.exports = function getPrompt(review, type) {
  return `Respond only with raw JSON. Do not include explanations, intros, or closing statements.
		...
		Your task is to detect emotional risk and causality. Focus on unmet expectations, forced choices, and trust violations. Use no extra language. No summaries. No reassurance. No markdown.
...
You must return only valid JSON. No surrounding text. Do not explain.
`.trim();
};