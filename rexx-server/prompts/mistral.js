module.exports = function getPrompt(review, type) {
  return `Respond only with raw JSON. Do not include explanations, intros, or closing statements.
		...
		Your task is to detect emotional risk and causality. Focus on unmet expectations, forced choices, and trust violations. Do not respond with prose.
...
Return JSON in exactly this format:
{
  ...
  "recommended_tone": string (e.g. "Direct, accountable, and non-defensive"),
   "behavioural_mode_name": string   // e.g. 'Trust Baseline', 'Ease Seeker','Resolution Hunter' 
}

ONLY return the JSON object. No formatting or Markdown.
`.trim();
};